...
export function processLaunchData(launchData: Launch[]): Record<string, Launchpad> {
  const launchpadCounts: Record<string, Launchpad> = {};
  
  // aggregate launches by launchpad and calculate statistics
  ...
  // set primary status based on most frequent occurrence
